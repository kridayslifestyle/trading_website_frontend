        ...
        <div className="flex items-center justify-between h-[68px]">
          ...
          <Link href="/" className="flex items-center gap-2.5 group">
            ...
            <div className="leading-none">
              <div className={`font-display font-bold text-lg leading-none tracking-tight transition-colors ${scrolled?"text-brand-900":"text-white"}`}>TradePro</div>
              <div className={`text-[10px] font-medium tracking-[.18em] uppercase transition-colors ${scrolled?"text-brand-400":"text-blue-300"}`}>Global</div>
            </div>
          </Link>
          ...
          <div className="hidden md:flex items-center gap-3">
            <Link href="/admin"
              className={`text-[13px] font-medium transition-colors ${scrolled?"text-slate-500 hover:text-brand-500":"text-white/65 hover:text-white"}`}>
              Admin Login
            </Link>
